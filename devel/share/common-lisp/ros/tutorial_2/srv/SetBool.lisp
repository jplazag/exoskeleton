...
(cl:defmethod cl:initialize-instance :after ((m <SetBool-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetBool-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tutorial_2-srv:<SetBool-request> is deprecated: use tutorial_2-srv:SetBool-request instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <SetBool-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tutorial_2-srv:data-val is deprecated.  Use tutorial_2-srv:data instead.")
  (data m))
...
(cl:defmethod cl:initialize-instance :after ((m <SetBool-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetBool-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tutorial_2-srv:<SetBool-response> is deprecated: use tutorial_2-srv:SetBool-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <SetBool-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tutorial_2-srv:success-val is deprecated.  Use tutorial_2-srv:success instead.")
  (success m))

(cl:ensure-generic-function 'message-val :lambda-list '(m))
(cl:defmethod message-val ((m <SetBool-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tutorial_2-srv:message-val is deprecated.  Use tutorial_2-srv:message instead.")
  (message m))
